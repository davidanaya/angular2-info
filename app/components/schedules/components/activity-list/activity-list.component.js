...
var ActivityListComponent = (function (_super) {
    ...
    function ActivityListComponent(schedulesService, commonCodesService) {
        _super.call(this, schedulesService, commonCodesService);
    }
    // on events
    ActivityListComponent.prototype.onUpdateFilter = function (event) {
        // not implemented
    };
    ActivityListComponent.prototype.updateSchedules = function (page) {
        // not implemented
    };
