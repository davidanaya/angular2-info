export * from './shared/schedules.service';
...
export * from './components/by-sport-and-date/by-sport-and-date.component';
export * from './components/schedule-by-noc/schedule-by-noc.component';
export * from './components/activity-list/activity-list.component';
